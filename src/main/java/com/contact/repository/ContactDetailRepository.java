...
import com.contact.entity.ContactDetailEntity;

/**
 * Spring Data is providing jpaRepository and jpaRepository providing cgLib
 * library which gives proxy class object
 * 
 * @author Ashish
 * @version 1.0
 * @since 22.12.2019 jpaRepository provide multiple pre-defined method to
